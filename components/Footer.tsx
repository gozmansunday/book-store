...
const Footer = () => {
  return (
    <footer className="sticky bottom-0 font-clash z-10">
      <div className="max-w-[80rem] mx-auto px-6 md:px-8">
        <div className="flex items-center justify-between border border-neutral-100 border-t-neutral-400 py-2 md:py-4">
          {/* Copyright */}
          <p>
