...
const NavMenu = () => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="flex flex-col items-end gap-4 font-ade text-2xl uppercase max-w-[84rem] mx-auto px-2 py-20 xs:gap-6 sm:gap-6 xs:text-4xl xs:py-24 md:py-32 md:text-6xl md:gap-8">
          {links.map((link) => (
