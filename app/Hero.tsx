        ...
        <div className='font-clash space-y-4 md:space-y-6 px-2'>
          ...
          <div className='grid gap-14 lg:grid-cols-2 lg:gap-20'>
            ...
            <section className='flex flex-col gap-8 md:flex-row'>
              <Image className='w-full mx-auto md:w-56 shadow-lg shadow-neutral-700/50' src={arrowOfGod} alt="arrow-of-god" />
              ...
              <div className='space-y-3'>
                ...
                <section className='space-y-6'>
                  <p className='line-clamp-[8] text-neutral-700'>
            ...
            {/* Book Image and Info */}
            <section className='flex flex-col gap-8 md:flex-row'>
              <Image className='w-full mx-auto md:w-56 shadow-lg shadow-neutral-700/50' src={americanah} alt="arrow-of-god" />

              <div className='space-y-3'>
                <section className=' font-semibold'>
                  <h4 className='text-xl'>Americanah</h4>
